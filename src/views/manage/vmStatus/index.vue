  ...
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="machineList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="设备状态" align="center" prop="runningStatus">
        <template #default="scope">
          <span v-if="scope.row.runningStatus != null && JSON.parse(scope.row.runningStatus).status === true" style="color: #409EFF;">正常</span>
      ...
      <el-table-column label="操作" align="center" class-name="small-padding fixed-width">
        <template #default="scope">
          <el-button link type="primary" @click="handleInfo(scope.row)"
            v-hasPermi="['manage:machine:query']">查看详情</el-button>
        </template>
      </el-table-column>
    </el-table>
